...
//     this.actions,
//     this.semanticLabel, this.bgColor = Colors.white,
...
// ///    dialogs, such as [CustomAlertDialog]s.
...
// ///   switch (await showCustomDialog<Department>(
// ///     context: context,
// ///     builder: (BuildContext context) {
...
// ///  * [Dialog], on which [SimpleDialog] and [CustomAlertDialog] are based.
// ///  * [showCustomDialog], which actually displays the dialog and returns its result.
// ///  * <https://material.google.com/components/dialogs.html#dialogs-simple-dialogs>
...
// /// `showCustomDialog` is originally called from. Use a [StatefulBuilder] or a

...
class EditDriverProfile extends StatefulWidget {
  EditDriverProfile({Key key}) : super(key: key);
...
class _EditDriverProfileState extends State<EditDriverProfile> {
  ...
  fetchDistrictListModel('5f665ee12d45902c98aa8f1f').then((value) {
      setState(() {
        distictList = value;
    ...
    fnameName.text = Global.driverUserModel.result.firstName;
    lnameName.text = Global.driverUserModel.result.lastName;
    //email.text = Global.driverUserModel.result.
    postoffice.text = Global.driverUserModel.result.postOffice;
    thana.text = Global.driverUserModel.result.thana;
    pincode.text = Global.driverUserModel.result.pincode;
    village.text = Global.driverUserModel.result.village;
    phone.text = Global.driverUserModel.result.mobile;
  ...
  addDriver(){
   if (readonly) {
     ...
     setState(() {
      ...
      id: Global.driverUserModel.result.sId
    ).then((value) {
      setState(() {

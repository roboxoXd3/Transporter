...
class UpdateDriverProfile {
  ...
  UpdateDriverProfile({this.status, this.message, this.data, this.token});

  UpdateDriverProfile.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
Future<UpdateDriverProfile> updatedriverProfile({String fname,String lastname ,
...
print(body);
  ...
  if (response.statusCode == 200) {
    ...
    return UpdateDriverProfile.fromJson(json.decode(response.body)) ;
    // print("Status OK");
  } else {
